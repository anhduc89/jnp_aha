...
<section class="content-header">
	<div class="content-header-left">
		<h1>Cài đặt bình luận Facebook</h1>
	</div>
</section>
			...
			<?php echo form_open(base_url().'admin/comment',array('class' => 'form-horizontal')); ?>
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<p style="padding-bottom: 20px;">Truy cập trang tạo bình luận bằng Facebook (<a href="https://developers.facebook.com/docs/plugins/comments/">https://developers.facebook.com/docs/plugins/comments/</a>) để lấy code và nhập vào form bên dưới.</p>
