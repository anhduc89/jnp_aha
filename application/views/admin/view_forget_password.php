...
<div class="login-box">
	<div class="login-logo">
  	...
  	<div class="login-box-body">
    	<h4 class="login-box-msg">Gởi lại Mật khẩu</h4>
		...
		<?php echo form_open(base_url().'admin/forget-password');?>
			...
			<div class="row">
				<div class="col-xs-8" style="padding-top:7px;"><a href="<?php echo base_url(); ?>admin/login" style="color:red;">Trở lại trang đăng nhập</a></div>
				<div class="col-xs-4">
