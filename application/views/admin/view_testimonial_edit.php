...
<section class="content-header">
	<div class="content-header-left">
		<h1>Chỉnh sửa nhận xét</h1>
	</div>
	<div class="content-header-right">
		<a href="<?php echo base_url(); ?>admin/testimonial" class="btn btn-primary btn-sm">Xem tất cả</a>
	</div>
</section>
				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Họ tên </th>*</span></label>
							<div class="col-sm-6">
								<input type="text" autocomplete="off" class="form-control" name="name" value="<?php echo $testimonial['name']; ?>">
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Chức danh <span>*</span></label>
							<div class="col-sm-6">
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Nhận xét <span>*</span></label>
							<div class="col-sm-6">
