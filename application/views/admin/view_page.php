                        ...
                        <!-- <div class="tab-pane active" id="tab_1">
                            ...
                            <?php echo form_open(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_home">Cập nhật</button>
                                    </div>
                                </div>                 
                            <?php echo form_close(); ?>

                            <h3 class="sec_title"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Vị trí chào mừng</h3>
                            <?php echo form_open_multipart(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Phụ đề </label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_home_welcome">Cập nhật</button>
                                    </select>
                                    </div>
                                </div>
                            <?php echo form_close(); ?>
                            
                            <h3 class="sec_title">Vị trí chào mừng (Video Background)</h3>
                            <?php echo form_open_multipart(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Hình nền Video </label>
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_home_welcome_video_bg">Cập nhật</button>
                                    </select>
                                    </div>
                                </div>
                            <?php echo form_close(); ?>
                            ...
                            <h3 class="sec_title"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Vị trí: tại sao chọn chúng tôi</h3>
                            <?php echo form_open_multipart(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Tiêu đề </label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        ...
                                        <option value="Show" <?php if($page_home['home_why_choose_status'] == 'Show') {echo 'selected';} ?>>Có</option>
                                        <option value="Hide" <?php if($page_home['home_why_choose_status'] == 'Hide') {echo 'selected';} ?>>Không</option>
                                    </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_home_why_choose">Cập nhật</button>
                                    </select>
                                    </div>
                                </div>
                            <?php echo form_close(); ?>
                            ...
                            <h3 class="sec_title"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Vị trí: Nổi bật</h3>
                            <?php echo form_open_multipart(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Tiêu đề </label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        ...
                                        <option value="Show" <?php if($page_home['home_feature_status'] == 'Show') {echo 'selected';} ?>>Có</option>
                                        <option value="Hide" <?php if($page_home['home_feature_status'] == 'Hide') {echo 'selected';} ?>>Không</option>
                                    </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_home_feature">Cập nhật</button>
                                    </select>
                                    </div>
                                </div>
                            <?php echo form_close(); ?>
                            ...
                            <h3 class="sec_title"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Vị trí: Dịch vụ</h3>
                            <?php echo form_open(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Tiêu đề </label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        ...
                                        <option value="Show" <?php if($page_home['home_service_status'] == 'Show') {echo 'selected';} ?>>Có</option>
                                        <option value="Hide" <?php if($page_home['home_service_status'] == 'Hide') {echo 'selected';} ?>>Không</option>
                                    </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <select name="counter_status" class="form-control select2" style="width:auto;">
                                            <option value="Show" <?php if($page_home['counter_status'] == 'Show') {echo 'selected';} ?>>Có</option>
                                            <option value="Hide" <?php if($page_home['counter_status'] == 'Hide') {echo 'selected';} ?>>Không</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_home_counter_text">Cập nhật</button>
                                    </div>
                                </div>
                            <?php echo form_close(); ?>

                            <h3 class="sec_title">Hình nền vị trí thông tin</h3>
                            <?php echo form_open_multipart(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Hình nền</label>
                                    <div class="col-sm-6" style="padding-top:6px;">
                                        <img src="<?php echo base_url(); ?>public/uploads/<?php echo $page_home['counter_photo']; ?>" class="existing-photo" style="height:180px;">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Thay đổi hình nền</label>
                                    <div class="col-sm-6" style="padding-top:6px;">
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_home_counter_photo">Cập nhật</button>
                                    </div>
                                </div>
                            <?php echo form_close(); ?>


                            <h3 class="sec_title"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Vị trí: Dự án</h3>
                            <?php echo form_open(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Tiêu đề </label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        ...
                                        <option value="Show" <?php if($page_home['home_portfolio_status'] == 'Show') {echo 'selected';} ?>>Có</option>
                                        <option value="Hide" <?php if($page_home['home_portfolio_status'] == 'Hide') {echo 'selected';} ?>>Không</option>
                                    </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_home_portfolio">Cập nhật</button>
                                    </select>
                                    </div>
                                </div>
                            <?php echo form_close(); ?>
                            ...
                            <h3 class="sec_title"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Vị trí: Tư vấn trực tuyến & FAQs</h3>
                            <?php echo form_open(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Tiêu đề Tư vấn trực tuyến </label>
                                    <div class="col-sm-6">
                                        <input type="text" name="home_booking_form_title" class="form-control" value="<?php echo $page_home['home_booking_form_title']; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Tiêu đề FAQS </label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        ...
                                        <option value="Show" <?php if($page_home['home_booking_status'] == 'Show') {echo 'selected';} ?>>Có</option>
                                        <option value="Hide" <?php if($page_home['home_booking_status'] == 'Hide') {echo 'selected';} ?>>Không</option>
                                    </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_home_booking">Cập nhật</button>
                                    </select>
                                    </div>
                                </div>
                            <?php echo form_close(); ?>
                            ...
                            <h3 class="sec_title">Hình nền vị trí tư vấn trực tuyến & FAQs</h3>
                            <?php echo form_open_multipart(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Hình nền</label>
                                    <div class="col-sm-6" style="padding-top:6px;">
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Thay đổi hình nền
                                    <div class="col-sm-6" style="padding-top:6px;">
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_home_booking_photo">Cập nhật</button>
                                    </div>
                                </div>
                            <?php echo form_close(); ?>
                            ...
                            <h3 class="sec_title"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Vị trí: Thành viên nhóm</h3>
                            <?php echo form_open(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Tiêu đề </label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        ...
                                        <option value="Show" <?php if($page_home['home_team_status'] == 'Show') {echo 'selected';} ?>>Có</option>
                                        <option value="Hide" <?php if($page_home['home_team_status'] == 'Hide') {echo 'selected';} ?>>Không</option>
                                    </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_home_team">Cập nhật</button>
                                    </select>
                                    </div>
                                </div>
                            <?php echo form_close(); ?>
                            ...
                            <h3 class="sec_title"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Vị trí: Bảng giá</h3>
                            <?php echo form_open(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Tiêu đề </label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        ...
                                        <option value="Show" <?php if($page_home['home_ptable_status'] == 'Show') {echo 'selected';} ?>>Có</option>
                                        <option value="Hide" <?php if($page_home['home_ptable_status'] == 'Hide') {echo 'selected';} ?>>Không</option>
                                    </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_home_pricing_table">Cập nhật</button>
                                    </select>
                                    </div>
                                </div>
                            <?php echo form_close(); ?>
                            ...
                            <h3 class="sec_title"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Vị trí: Người dùng nhận xét</h3>
                            <?php echo form_open(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Tiêu đề </label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        ...
                                        <option value="Show" <?php if($page_home['home_testimonial_status'] == 'Show') {echo 'selected';} ?>>Có</option>
                                        <option value="Hide" <?php if($page_home['home_testimonial_status'] == 'Hide') {echo 'selected';} ?>>Không</option>
                                    </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_home_testimonial">Cập nhật</button>
                                    </select>
                                    </div>
                                </div>
                            <?php echo form_close(); ?> 
                            ...
                            <?php echo form_open_multipart(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_home_testimonial_photo">Cập nhật</button>
                                    </div>
                                </div>
                            <?php echo form_close(); ?>


                            <h3 class="sec_title"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Vị trí: Tin mới cập nhật</h3>
                            <?php echo form_open(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Tiêu đề </label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Số lượng tin hiển thị? </label>
                                    <div class="col-sm-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        ...
                                        <option value="Show" <?php if($page_home['home_blog_status'] == 'Show') {echo 'selected';} ?>>Có</option>
                                        <option value="Hide" <?php if($page_home['home_blog_status'] == 'Hide') {echo 'selected';} ?>>Không</option>
                                    </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_home_blog">Cập nhật</button>
                                    </select>
                                    </div>
                                </div>
                            <?php echo form_close(); ?>
                        ...
                        <div class="tab-pane" id="tab_5">
                            <?php echo form_open(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_service">Cập nhật</button>
                                    </div>
                                </div>                              
                            <?php echo form_close(); ?>
                        </div>
                        ...
                        <div class="tab-pane" id="tab_7">
                            <?php echo form_open(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_testimonial">Cập nhật</button>
                                    </div>
                                </div>                              
                            <?php echo form_close(); ?>
                        </div>
                        ...
                        <div class="tab-pane" id="tab_8">
                            <?php echo form_open(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_news">Cập nhật</button>
                                    </div>
                                </div>                              
                            <?php echo form_close(); ?>
                        </div>
                        ...
                        <div class="tab-pane" id="tab_16">
                            <?php echo form_open(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_event">Cập nhật</button>
                                    </div>
                                </div>                              
                            <?php echo form_close(); ?>
                        </div> -->
                        ...
                        <!-- <div class="tab-pane" id="tab_10">
                            <?php echo form_open(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_search">Cập nhật</button>
                                    </div>
                                </div>                              
                            <?php echo form_close(); ?>
                        </div>
                        ...
                        <div class="tab-pane" id="tab_11">
                            <?php echo form_open(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_term">Cập nhật</button>
                                    </div>
                                </div>                              
                            <?php echo form_close(); ?>
                        </div>
                        ...
                        <div class="tab-pane" id="tab_12">
                            <?php echo form_open(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_privacy">Cập nhật</button>
                                    </div>
                                </div>                              
                            <?php echo form_close(); ?>
                        </div>
                        ...
                        <div class="tab-pane" id="tab_14">
                            <?php echo form_open(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_team">Cập nhật</button>
                                    </div>
                                </div>                              
                            <?php echo form_close(); ?>
                        </div>
                        ...
                        <div class="tab-pane" id="tab_15">
                            <?php echo form_open(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_portfolio">Cập nhật</button>
                                    </div>
                                </div>                              
                            <?php echo form_close(); ?>
                        </div> -->
